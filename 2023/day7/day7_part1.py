...
# 2 * Four of a kind, where four cards have the same label and one card has a
#     different label: `AA8AA`
# 3 * Full house, where three cards have the same label, and the remaining two
#     cards share a different label: `23332`
...
#     label, and the remaining card has a third label: `23432`
# 6 * One pair, where two cards share one label, and the other three cards have
#     a different label from the pair and each other: `A23A4`
